                            ...
                            <tbody>
                                {users.map((user) => (
                                    <tr key={user.id}>
                                        ...
                                        <td>
                                            <span className={`aum-badge ${STATUS_BADGE[user.status]}`}>
                                                {user.status}
                                            </span>
                                        </td>
                    ...
                    <div className="aum-detail-panel">
                        ...
                        <div className="aum-detail-body">
                            {[
                                ...
                                ["Total Sessions", selectedUser.total_sessions],
                                ...
                                <div key={label} 
                                    ...
                                    <span className="aum-detail-value">
                                        {label === "Status" ? (
                                            <span className={`aum-badge ${STATUS_BADGE[value]}`}>
                                                {value}
                                            </span>
                                        ) : value}
                                    </span>
                            ...
                            <div className="aum-detail-row">
                                ...
                                <span className={`aum-badge ${STATUS_BADGE[selectedUser.status]}`}>
                                    {selectedUser.status}
                                </span>
                            </div>
                        </div>
                ...
                <div className="aum-modal-overlay">
                    <div className="aum-modal">
                        ...
                        <p className="aum-modal-note">
                            The user will receive an automated 
                            notification.
                        </p>
