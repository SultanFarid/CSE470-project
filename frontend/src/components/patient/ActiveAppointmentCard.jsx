...
export default function ActiveAppointmentCard({
  ...
  return (
    <section className="dashboard-card span-7 flex-column gap-16">
        ...
        <div className="appointment-details-box">
          <div className="appointment-meta-left">
            ...
            <div className="therapist-info">
              <h3 className="therapist-name">{currentApp.therapist_name || patientUser.therapist || 'Dr. Sultan M. Farid'}</h3>
              <p className="therapist-specialty">
                {currentApp.therapist_specialties || 'Clinical Psychology'} · {currentApp.session_type === 'in-person' ? 'In-Person Session' : 'Online Video Session'}
              </p>
      ...
      {/* Feature 7: Post-Session Review & Feedback Banner */}
      {!reviewSubmitted ? (
        <div className="feedback-alert-box">
          <div className="feedback-text-content">
            <h4 className="feedback-alert-title">
              <ShieldAlert size={16} className="inline-icon warning" />Pending Review: Past Session with Dr. Ayesha
            </h4>
          ...
          <div className="feedback-action-row">
            <button
              ...
              onClick={() => openReviewModal && openReviewModal({ id: 1, name: 'Dr. Ayesha Rahman', specialties: 'Anxiety, Depression' })}
            >
              ★ Rate 1-5 Stars
            </button>
            <span
        ...
        <div className="feedback-alert-box" style={{ background: '#f0fdf4', border: '1px solid #bbf7d0' }}>
          <div className="feedback-text-content">
            <h4 className="feedback-alert-title" style={{ color: '#15803d', display: 'flex', alignItems: 'center', gap: '6px' }}>
              <CheckCircle2 size={16} color="#16a34a" /> Review Submitted for Dr. Ayesha Rahman
            </h4>
